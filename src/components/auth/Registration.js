...
export function Registration() {
    ...
    function handleSubmit(e) {
        ...
        formDataObj.role = [formDataObj["role"]][0]
        delete formDataObj.confirmPassword;

        apiPost('/v1/auth/register', formDataObj)
            .then((response) => {
                setLoading(false)
    ...
    return (
        ...
        >
            ...
            <div className='text-center mb-11'>
                ...
                <div className='text-gray-500 fw-semibold fs-6'>Your next prized possession is just a click away – get
                    ready to buy, sell, and succeed with our one-of-a-kind buying and selling app!
                </div>
            </div>
            {/* end::Heading */}
            ...
            <div className='fv-row mb-8'>
                ...
                <select data-control="select2" className="form-select" name="role"
